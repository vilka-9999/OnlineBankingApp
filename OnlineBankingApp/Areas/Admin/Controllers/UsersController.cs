...
namespace OnlineBankingApp.Areas.Admin.Controllers
{
    ...
    public class UsersController : Controller
    {
        ...
        public UsersController(OnlineBankingAppContext context)
        {
            _context = context;
        }
        ...
        {
            var onlineBankingAppContext = _context.Users.Include(u => u.Advisor);
        ...
        {
            ViewData["AdvisorId"] = new SelectList(_context.Advisors, "AdvisorId", "AdvisorName");
            return View();
        }
        ...
        public async Task<IActionResult> Create([Bind("UserId,FirstName,LastName,Email,Username,Password,AdvisorId")] User user)
        {
            ...
            ViewData["AdvisorId"] = new SelectList(_context.Advisors, "AdvisorId", "AdvisorName", user.AdvisorId);
            return View(user);
        }
